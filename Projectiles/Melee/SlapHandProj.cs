...
{
	public class SlapHandProj : ModProjectile
	{
		private const string ChainTexturePath = "WorldsCollide/Projectiles/Melee/SlapHandProj_Chain"; // The folder path to the flail chain sprite
